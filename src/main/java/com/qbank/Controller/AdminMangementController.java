...
public class AdminMangementController {
    ...
    public String dashboard(HttpSession session, Model model) {
        ...
        java.util.List<Result> allResults = resultRepository.findAll();
        ...
        java.util.List<Test> tests = testRepository.findAll();

        // 3. Preload detailed test analytical rosters
        Map<Long, Map<String, Object>> testAnalysis = new HashMap<>();
        for (Test test : tests) {
            java.util.List<Result> testResults = resultRepository.findByTestId(test.getId());
